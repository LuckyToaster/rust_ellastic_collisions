...
fn util_collide_distance_particle_update() {
    ...
    let mut p1 = Particle::new(pos, vel, acc, 6.0, 10.0, Color::BLACK);
    let mut p2 = Particle::new(pos, acc, acc, 6.0, 10.0, Color::BLACK);
    let p3 = Particle::new(pos, vel, acc, 6.0, 10.0, Color::BLACK);
...
fn util_overlap_solve_overlap() {
    let mut p1 = Particle::new(v(5.0, 10.0), v(0.0, 0.0), v(0.0, 0.0), 100.0, 10.0, rcolor());  
    let mut p2 = Particle::new(v(10.0, 10.0), v(0.0, 0.0), v(0.0, 0.0), 100.0, 10.0, rcolor());  
